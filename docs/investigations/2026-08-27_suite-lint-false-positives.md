...
| single-distinct-literal | 206 | 193 | 13 |
...
Three more findings arrived on 2026-09-16 with the loop-tick, teardown and ds-waiver tests —
one `positive-match-failure-vocabulary`, two `single-distinct-literal`, none audited, all in the
true-positive column by arithmetic like the rest.
...
Unparseable files: 0 of 246 linted. Every file the walker reached was extracted; nothing was dropped
